...
import UserHeader from './components/game/UserHeader';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const boxesOpened = boxes.filter(b => b.isOpen).length;
    const finalScore = boxes.reduce((acc, b) => {
      if (!b.isOpen) return acc;
      return acc + (b.hasTreasure ? 200 : -50);
    }, 0);
    apiPost('/api/scores', { finalScore, won, boxesOpened }).catch(() => {});
  }, [gameEnded]);
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-amber-100 flex flex-col items-center">
      ...
      <div className="flex flex-col items-center justify-center p-8 w-full">
        ...
        <div className="mb-8 flex items-center gap-4">
          <div className={`text-2xl font-bold p-4 rounded-lg shadow-lg border-2 min-w-24 text-center ${
            score > 0
